...
navegador: login, PDV com leitura de carteirinha e de produto, venda fiado e paga na hora, retirada por item e por
ficha, conta do aluno com crédito, reconciliação, contagem de sobras e restrições do perfil operador. Screenshots
ficam em `e2e/shots/`.
